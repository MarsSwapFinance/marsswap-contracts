...
contract('MasterPlanet', ([deployer, alice, bob, carol, governor]) => {
  ...
  beforeEach(async () => {
    ...
    await this.masterPlanet.setReferral(referral.address, { from: deployer })
    ...
    this.masterPlanet.add(1000, this.lp1.address, 0, true, { from: deployer })
  ...
  describe('Update MARS emission', () => {
    it('should update MARS token emission rate', async () => {
      ...
      await this.masterPlanet.updateEmissionRate('100000000')
